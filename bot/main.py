...
def finish_register(message: telebot.types.Message, other_data: dict):
    ...
    resp = requests.post(BASE_URL + "register/", other_data)
...
def send_activation_code(message: telebot.types.Message):
    ...
    resp = requests.post(BASE_URL + "activate/", {"email": email, "code": code})
...
def finish_login(message: telebot.types.Message):
    ...
    resp = requests.post(BASE_URL + "login/", {"email": email, "password": password})
